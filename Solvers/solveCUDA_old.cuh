...
__host__ void SolveCUDA(int seed,Eigen::Vector2d X0,double T, double* boundary_parameters, double h,int N_tray, pfscalar g, int Nx, int Ny, Typef f, Typec c, bool VARC,
    ...
    unsigned int N=0; int added=NUMBLOCKS*BLOCKSIZE;
...
__host__ void SolveCUDA(int seed,Eigen::Vector2d X0,double T, double* boundary_parameters, double h,int N_tray, pfscalar g, int Nx, int Ny, Typef f, Typec c, bool VARC,Typeu ux, Typeu uy,
                        double* phi, double* phi2, double* phi3, double* phi4, double* phixi, double* phi_plus_xi2, double* xi, double* xi2, double* tau, double* tau2){
    bool EMFlag=false;
    //Calcular tiempo de ejecucións
    cudaEvent_t start, stop;
...
///MODO XYZ
template <typename Typef,typename Typec, typename Typeu>
__host__ void SolveCUDA(int seed,Eigen::Vector2d X0,double T, double* boundary_parameters, double h,int N_tray, int Nx, int Ny, Typef f, Typec c,bool VARC,
...
template <typename Typef,typename Typec, typename Typeu>
__host__ void SolveCUDA(int seed,Eigen::Vector2d X0,double T, double* boundary_parameters, double h,int N_tray, int Nx, int Ny, Typef f, Typec c,bool VARC, Typeu ux, Typeu uy,
                          double* X_tau_lin_1, double* X_tau_lin_2, double* Y_tau_lin, double* Z_tau_lin){
  bool EMFlag=false;
  //Calcular tiempo de ejecucións
  cudaEvent_t start, stop;
...
///MODO XYZ
template <typename Typef,typename Typec, typename Typeu>
__host__ void SolveCUDA(int seed,Eigen::Vector2d X0,double T, double* boundary_parameters, double h,int N_tray, int Nx, int Ny, Typef f, Typec c, bool EMFlag,bool VARC,
                          double* X_tau_lin_1, double* X_tau_lin_2, double* Y_tau_lin, double* Z_tau_lin,
...
///MODO XYZ
template <typename Typef,typename Typec, typename Typeu>
__host__ void SolveCUDA(int seed,Eigen::Vector2d X0,double T, double* boundary_parameters, double h,int N_tray, int Nx, int Ny, Typef f, Typec c, bool EMFlag,bool VARC, Typeu ux, Typeu uy,
                          double* X_tau_lin_1, double* X_tau_lin_2, double* Y_tau_lin, double* Z_tau_lin,
                          double* X_tau_sublin_1, double* X_tau_sublin_2, double* Y_tau_sublin, double* Z_tau_sublin){
  //Calcular tiempo de ejecucións
  cudaEvent_t start, stop;
